(function($) {
    ...
    NAY.Accordion = function() {
        $('.accordion').each(function(i, elem) {
            var $elem = $(this)
            var $acpanel = $elem.find('.acco-group > .acco-des')
            var $acsnav = $elem.find('.acco-group > .acco-heading')
            ...
            loadScript(
                ...
                function() {
                    owlslider.each(function() {
                        ...
                        var $navdots = $this.data('nav-dots') ?
                            $this.data('nav-dots') :
                            false
                        var $navarrow = $this.data('nav-arrow') ?
                            $this.data('nav-arrow') :
                            false
                        var $autoplay = $this.attr('data-autoplay') ?
                            $this.data('autoplay') :
                            true
                        var $autospeed = $this.attr('data-autospeed') ?
                            $this.data('autospeed') :
                            5000
                        var $smartspeed = $this.attr('data-smartspeed') ?
                            $this.data('smartspeed') :
                            1000
                        var $autohgt = $this.data('autoheight') ?
                            $this.data('autoheight') :
                            false
                        var $CenterSlider = $this.data('center') ?
                            $this.data('center') :
                            false
        ...
        if ($('#type-it').exists()) {
            loadScript(plugin_track + 'typeit-master/typeit.min.js', function() {
                new TypeIt('#type-it', {
                    speed: 200,
                    loop: true,
                    strings: ['UI/UX Enthusiast', 'Web Developer', 'Technologist', 'Front-End Specialist', 'Humdrum Guitarist'],
                    breakLines: false
                })
            })
        }
